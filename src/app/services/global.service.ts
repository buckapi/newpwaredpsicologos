...
import { RealtimeProfesionalesService } from './realtime-profesionales.service';
import { RealtimeRegionesService } from './realtime-regiones.service';
...
export class GlobalService {
  ...
  constructor(
    ...
    public realtimeProfesionales: RealtimeProfesionalesService
  ) 
  { 
...
getPreviewProfesional(): Profesionals {
  ...
  goToDetail(profesional: any) {
    ...
    alert("id" + profesional.id)
    this.previewProfesionals = profesional; // Asigna el profesional seleccionado
    this.setRoute('detail-doctor'); // Navega al componente detail-doctor
  }
